...
(function(exports) {
          ...
          return function (oldx) {
              return function (oldy) {
                  return function (e) {
                      return function (v) {
                          return function __do() {
                              var v1 = Control_Monad_Eff_JQuery.getPageX(e)();
                              var v2 = Control_Monad_Eff_JQuery.getPageY(e)();
  ...
  var main = Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
      ...
      var v3 = Graphics_Canvas.getCanvasElementById("canvas")();
      var __unused = function (dictPartial1) {
          return function ($dollar30) {
              return $dollar30;
          };
      };
      return __unused()((function () {
          if (v3 instanceof Data_Maybe.Just) {
              return function __do() {
                  ...
                  Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Eff.forE(0)(8)(function (i) {
                      ...
                      return Data_Functor["void"](Control_Monad_Eff.functorEff)(Data_Array_ST.pushSTArray(v6)(yy));
                  }))();
                  ...
                  Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Eff.forE(0)(12)(function (i) {
                      ...
                      var yy = Data_Maybe.fromMaybe([  ])(xx);
                      return Data_Functor["void"](Control_Monad_Eff.functorEff)(Data_Array_ST.pushSTArray(v7)(yy));
                  }))();
                  var updateCube = function __do() {
                      var v8 = Data_Array_ST.emptySTArray();
                      Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Eff.forE(0)(8)(function (i) {
                          return function __do() {
                              var v9 = Data_Array_ST.peekSTArray(v6)(i)();
                              var vi = Data_Maybe.fromMaybe([  ])(v9);
                              ...
                              var v10 = rotateX(30.0 * 20.0)(x)(y)(z);
                              var mvx = Data_Array.index(v10)(0);
                              var mvy = Data_Array.index(v10)(1);
                              var mvz = Data_Array.index(v10)(2);
                              var vx = Data_Maybe.fromMaybe(0.0)(mvx);
                              var vy = Data_Maybe.fromMaybe(0.0)(mvy);
                              var vz = Data_Maybe.fromMaybe(0.0)(mvz);
                              var vv = rotateY(20.0 * 30.0)(vx)(vy)(vz);
                              Data_Functor["void"](Control_Monad_Eff.functorEff)(Data_Array_ST.pushSTArray(v8)(vv))();
                              var v11 = Data_Array_ST.emptySTArray();
                              return Data_Functor["void"](Control_Monad_Eff.functorEff)(Data_Array_ST.pushSTArray(v11)(1))();
                          };
                      }))();
                      drawCube(v8)(v7)(v4)();
          ...
          throw new Error("Failed pattern match at Main line 108, column 3 - line 109, column 3: " + [ v3.constructor.name ]);
      })())();
  });
